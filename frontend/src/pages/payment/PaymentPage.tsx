...
const PaymentPage = () => {
 ...
 if (!order) {
  return (
   <div className="p-6 max-w-4xl mx-auto">
    <div className="bg-yellow-50/20 border border-yellow-200 text-yellow-700 px-6 py-4 rounded-xl">
 ...
 return (
  <div className="p-6 max-w-4xl mx-auto">
   ...
   <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
    ...
    <div className="flex items-center gap-2 bg-primary-50/20 border border-primary-200 px-4 py-3 rounded-xl">
   ...
   <div className="bg-white rounded-2xl shadow-soft p-6 mb-8">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
     ...
     <div className="space-y-1">
      ...
      <span className="inline-flex px-3 py-1 text-sm font-semibold rounded-full bg-primary-100/30 text-primary-800">
       ...
       >
        <div className="flex-1">
         <div className="flex items-center gap-2">
          <span className="inline-flex items-center justify-center w-6 h-6 bg-primary-100/30 text-primary-800 text-sm font-semibold rounded-full">
           {item.quantity}
          </span>
         ...
         {item.notes && (
          <p className="text-sm text-neutral-600 mt-1 ml-8">
   ...
   {paymentStatus ==="success" && (
    <div className="bg-white rounded-2xl shadow-soft p-8">
     <div className="flex flex-col items-center justify-center py-8">
      <div className="w-20 h-20 bg-green-100/30 rounded-full flex items-center justify-center mb-6">
   ...
   {paymentStatus ==="error" && (
    <div className="bg-white rounded-2xl shadow-soft p-8">
     <div className="flex flex-col items-center justify-center py-8">
      <div className="w-20 h-20 bg-red-100/30 rounded-full flex items-center justify-center mb-6">
