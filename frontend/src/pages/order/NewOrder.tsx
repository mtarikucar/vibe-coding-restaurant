 ...
 return (
  <div className="p-6 max-w-7xl mx-auto">
   ...
   <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
    ...
    {table && (
     <div className="bg-primary-50/20 border border-primary-200 px-4 py-3 rounded-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
       {filteredMenuItems.length === 0 ? (
        <div className="col-span-2 text-center py-12">
         <div className="mb-4">
          <ShoppingCartIcon className="mx-auto h-12 w-12 text-neutral-400" />
         </div>
        ...
        filteredMenuItems.map((item) => (
         <div
          key={item.id}
          className="bg-neutral-50 border border-neutral-200 rounded-xl shadow-sm overflow-hidden hover:shadow-md transition-shadow"
         >
          <div className="p-6">
