...
const BulkMenuUpload: React.FC<BulkMenuUploadProps> = ({
 ...
 return (
  <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
   <div className="bg-neutral-100 rounded-2xl w-full max-w-6xl max-h-[90vh] overflow-y-auto shadow-soft">
     ...
     <div className="mb-6">
      <div className="flex flex-wrap gap-4 mb-4">
       ...
       <div className="relative">
        ...
        <label
         htmlFor="csv-upload"
         className="inline-flex items-center px-4 py-2 border border-neutral-300 rounded-xl shadow-sm text-sm font-medium text-primary-700 bg-neutral-100 hover:bg-neutral-200 cursor-pointer transition-colors"
        >
      ...
      <div className="bg-primary-50/20 border border-primary-200 rounded-xl p-4">
        ...
        >
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col">
           ...
           <div className="flex-1 border-2 border-dashed border-neutral-300 rounded-xl p-4 text-center">
            {item.imagePreview ? (
             <div className="relative">
              <img
