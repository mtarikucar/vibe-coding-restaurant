...
const MenuVisualization: React.FC<MenuVisualizationProps> = ({
 ...
 return (
  <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
   <div className="bg-neutral-100 rounded-2xl w-full max-w-7xl max-h-[95vh] overflow-hidden shadow-soft">
    {/* Header */}
    ...
    <div className="flex h-[calc(95vh-120px)]">
     {/* Customization Panel */}
     {showCustomization && (
      <div className="w-80 bg-white border-r border-neutral-300 p-6 overflow-y-auto">
       ...
       <div className="space-y-4">
        <div>
         ...
         <select
          ...
          className="w-full bg-neutral-100 border border-neutral-300 rounded-xl px-3 py-2 text-primary-900"
         >
