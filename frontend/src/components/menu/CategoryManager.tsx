...
const CategoryManager: React.FC<CategoryManagerProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-neutral-100 dark:bg-darkGray-800 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-soft">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center mt-4">
              <input
                ...
                className="h-4 w-4 text-primary-600 focus:ring-primary-500 border-neutral-300 dark:border-darkGray-600 rounded transition-colors"
              />
              <label
            ...
            {categories.length === 0 ? (
              ...
              <div className="space-y-3">
                {categories.map((category) => (
                  <div
                    key={category.id}
                    className="bg-white dark:bg-darkGray-700 rounded-xl p-4 border border-neutral-200 dark:border-darkGray-600"
                  >
                    {editingCategory && editingCategory.id === category.id ? (
                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center">
                          <span
                            className={`text-primary-900 dark:text-neutral-100 font-medium ${
                          ...
                          {category.isActive === false && (
                            <span className="ml-3 text-xs bg-neutral-200 dark:bg-darkGray-600 text-neutral-600 dark:text-neutral-400 px-2 py-1 rounded-full">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <button
                            ...
                            className="text-danger-600 hover:text-danger-800 dark:text-danger-400 dark:hover:text-danger-300 transition-colors p-1"
