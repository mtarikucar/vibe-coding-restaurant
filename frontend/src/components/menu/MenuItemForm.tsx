...
const MenuItemForm: React.FC<MenuItemFormProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-neutral-100 dark:bg-darkGray-800 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto shadow-soft">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <label
                  htmlFor="isAvailable"
                  className="text-sm font-medium text-primary-700 dark:text-neutral-300 cursor-pointer"
                >
                ...
                <div
                  className={`relative border-2 border-dashed rounded-xl transition-all duration-200 ${
                    dragActive
                      ...
                      : "border-neutral-300 dark:border-darkGray-600 hover:border-primary-400"
                  }`}
                  onDragEnter={(e) => {
                    e.preventDefault();
                    e.stopPropagation();
                ...
                >
                  {imagePreview ? (
                    ...
                    <div className="p-8 text-center">
                      <PhotoIcon className="mx-auto h-16 w-16 text-neutral-400 dark:text-neutral-500 mb-4" />
